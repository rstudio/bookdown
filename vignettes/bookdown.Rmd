...
* The [Books](https://bookdown.org/home/archive/) section lists books published using the [_bookdown.org_ hosting service](https://bookdown.org/yihui/bookdown/rstudio-connect.html), provided by [RStudio Connect](https://rstudio.com/products/connect/).
* The [Contest](https://bookdown.org/home/contest/) section showcases the award recipients and their bookdown applications from the [2018 bookdown contest](https://blog.rstudio.com/2018/07/27/first-bookdown-contest/).
