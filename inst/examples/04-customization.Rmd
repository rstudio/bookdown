...
- `pandoc_file_scope`: whether to have pandoc parse each chapter individually before combining them into the final book document. This will allow footnotes in different files with the same identifiers to work as expected. If this option is set, footnotes and links will not work across files.
