...
- `use_references_scope`: whether to pass a `references_scope` function to `rmarkdown::render()`, which in the case that duplicate footnote identifiers exist, enables rmarkdown to split the book into chapters and invoke pandoc using the  `--file-scope` option.
