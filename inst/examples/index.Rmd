...
This book and the package **bookdown** are for beta testers, and should not be considered stable at the moment. You are welcome to experiment with this package, and feedback may be sent to https://github.com/rstudio/bookdown/issues
```
