...
```{r fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html4'), fig.link='https://www.crcpress.com/product/isbn/9781138700109'}
...
```{r fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html4'), fig.link='https://github.com/rstudio/bookdown'}
