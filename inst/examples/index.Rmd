...
Despite that the package name contains the word "book", **bookdown** is not only for books. The "book" can be anything that consists of multiple R Markdown documents meant to be read in a linear sequence, such as course handouts, study notes, a software manual, a master/PhD thesis, or even a diary. In fact, many **bookdown** features apply to single R Markdown documents as well (Section \@ref(a-single-document)).
