...
```{block2, type='rmdnote'}
If you're planning on printing your book to PDF, you'll need a version of LaTeX. You are recommended to install TinyTeX (which includes XeLaTeX): <https://yihui.name/tinytex/>.
```
