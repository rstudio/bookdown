...
If you would like a word_document2 output, you may find that the equation environment is not rendered, i.e. you probably cannot see the equation in the Word document. The easiest way to solve this problem is shown in the following example:
...
Thus the equation can be rendered in the Word document with a number and reference. 
