...
Equation references work best for LaTeX/PDF output, and it partially works for HTML output in the sense that you cannot refer to equations on other pages. Currently this feature is not available to Word output or e-books. It may be improved in the future versions of **bookdown**.
...
Currently the index is only supported for LaTeX/PDF output. To print an index after the book, you can use the LaTeX package **makeidx** in the preamble (see Section \@ref(yaml-options)):
