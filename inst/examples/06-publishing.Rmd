...
+ Alternately, you may use the function `bookdown::create_gitbook()` or `bookdown::create_bs4_book()` from your R console.
:::
...
You'll also see a notice that unclaimed sites are deleted after 24 hours. You can sign up for a Netlify account to claim your site and keep it online permanently. If you do decide to sign up for a Netlify account, we recommend signing up with *GitHub* to connect your GitHub and Netlify accounts. If you use a different version control service, select GitLab or BitBucket instead.

### *Optional: Update your site*

After signing up for Netlify, you *can* update this kind of site, but it is a manual update. Go to Netlify.com (<https://www.netlify.com/>) and navigate to find your site, then click on *Deploys*. You should see a box indicating you may drag and drop your site folder to update your site (you may need to scroll to the bottom of this page):
