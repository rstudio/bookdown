...
In the LaTeX preamble (Section \@ref(yaml-options)), we have a few more settings. First, we set the main font to be "Alegreya", and since this font does not have the <span style="font-variant:small-caps;">Small Capitals</span> feature, we used the "Alegreya SC" font.
...
We printed the index in `latex/after_body.tex` (Section \@ref(index)).
