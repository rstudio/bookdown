...
bookdown::gitbook:
  config:
    ...
    download: null
    search:
      engine: lunr # valid options are ['lunr', 'fuse'], else default to 'lunr'
      opts: null # options to control/tune search engine behaviour (e.g fuse.js refer to https://fusejs.io/api/options.html)
    fontsettings:
      theme: white
      family: sans
      size: 2
