...
```{r fig.align='center', echo=FALSE, fig.link='https://mastering-shiny.org', fig.cap="Home page of a book with the three-column Bootstrap style.", out.width=if(knitr::is_latex_output()) '100%'}
