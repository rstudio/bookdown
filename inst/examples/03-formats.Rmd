...
That means each file *must* start with a first-level heading, `# Chapter title`, and that must be the only first-level heading in the file. 
...
Making your citations _footnotes_ allows readers to read them near the text where they're used because `bs4_book` makes footnotes appear inline when clicked. 
