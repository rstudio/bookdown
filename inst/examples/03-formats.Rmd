...
The first- and second-level headings will appear in that chapter's sidebar on the upper right as a "sticky" within-chapter table of contents that stays in place as you scroll down. In the sidebar, when a section is navigated to, subheadings will auto-expand such that third-level headings like "A subsection" are visible.
...
like `chicago-fullnote-bibliography.csl` (we recommend: <https://www.zotero.org/styles/>), then
