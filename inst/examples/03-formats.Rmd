...
If you do not use RStudio or prefer a function, you can create the same project template with `bookdown::create_bs4_book()` from your R console. See `?create_bs4_book` or the onlin documentation (<https://pkgs.rstudio.com/bookdown/reference/create_book.html>) for help.
