...
This output format builds upon the Bootstrap CSS framework, an open source library of reusable chunks of HTML, CSS, and JavaScript code. This format uses version 4 of Bootstrap (<https://getbootstrap.com/docs/4.0/>).
